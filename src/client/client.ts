        ...
        fbxLoader.load(
            ...
            (object) => {
                ...
                fbxLoader.load(
                    'models/mma_kick.fbx',
                    (object) => {
                        console.log('loaded mma_kick')
                        const animationAction = mixer.clipAction(
                            (object as THREE.Object3D).animations[0]
                        )
                        animationActions.push(animationAction)
                        animationsFolder.add(animations, 'mma_kick')

                        //add an animation from another file
                        fbxLoader.load(
                            'models/breakdance_1990.fbx',
                            (object) => {
                                console.log('loaded breakdance_1990');
                                ...
                                animationActions.push(animationAction)
                                animationsFolder.add(animations, 'breakdance_1990')
